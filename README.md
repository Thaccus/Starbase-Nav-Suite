...
How to use: Stop the ship. Enter a waypoint either by saving and/or selecting it then Loading it via Archageos Waypointing system (You can also enter it by putting three numers into the :: panel's value thanks to Firestar99). Press nav to go there or point at it manually with compass and go yourself.

FAQ: Requires questions and nobody has asked any yet.
